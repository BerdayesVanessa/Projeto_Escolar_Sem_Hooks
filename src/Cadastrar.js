...
export default class Cadastrar extends React.Component {
  ...
  save(event) {
    ...
    fetch("http://localhost:3001/dadosPessoais", {
      ...
      body: JSON.stringify(newDadosPessoa)
    });

    this.setState({ nome: "" });
    this.props.cadastrarDadosPessoaCallback();
  }
              ...
              <div class="col-3">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="rg"
                    placeholder="Digite o seu RG/RNM"
                  ></input>
                </div>
              </div>
              <div class="col-3">
              ...
              <div class="col-3">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="curso"
                    placeholder="Digite o nome de seu curso"
                  ></input>
                  <small id="cursoHelp" class="form-text text-muted">
